...
```
As @fig-probability1 illustrates the probability of the quality score being classified as good based on aroma grade, it is evident that higher aroma grades correspond to a higher probability of being classified as good quality. Similar interpretations will used for @fig-probability2, @fig-probability3.
```{r}
#| echo: true
